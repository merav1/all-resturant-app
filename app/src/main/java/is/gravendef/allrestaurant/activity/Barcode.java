    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        camera.setScannerViewEventListener(new ScannerLiveView.ScannerViewEventListener() {
            ...
            public void onScannerStarted(ScannerLiveView scanner) {
                ...
                Toast.makeText(Barcode.this, "Scanner Started", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onScannerStopped(ScannerLiveView scanner) {
                // method is called when scanner is stopped.
                Toast.makeText(Barcode.this, "Scanner Stopped", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onScannerError(Throwable err) {
                // method is called when scanner gives some error.
                Toast.makeText(Barcode.this, "Scanner Error: " + err.getMessage(), Toast.LENGTH_SHORT).show();
            }
